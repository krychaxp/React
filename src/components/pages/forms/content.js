...
const digits = (a) => ({
  pl: `Podana wartość musi zawierać ${a} cyfr`,
  en: `This input must have ${a} digits`,
});
const char = (a) => ({
  pl: `Podana wartość musi zawierać min. ${a} znaki`,
  en: `This input must have min ${a} characters`,
});
export default {
  form: {
    status: {
